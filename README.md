...
1. Crie / inicie com um dos comandos abaixo:
    ...
    - Use esse para usar o mapeamento de portas com as mesmas numerações no localhost (recomendado)
        ...
        ```sh
        docker run -p 8000:8000 -p 44300:44300 -p 3300:3300 -p 3200:3200 -p 8101:8101 -p 3300:3300 -h vhcalnplci --name nwabap752 -it nwabap:7.52 /bin/bash
        ```
    ...
    **Dica:** Você também pode usar `--rm` para o container ser excluído logo após você sair do terminal ou ele for parado 
      ...
      ```sh
      docker run -p 8000:8000 -p 44300:44300 -p 3300:3300 -p 3200:3200 -p 8101:8101 -p 3300:3300 -h vhcalnplci --rm --name nwabap752 -it nwabap:7.52 /bin/bash
      ```
